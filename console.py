...
class HBNBCommand(cmd.Cmd):
    ...
    def do_update(self, arguments):
        ...
        Ex: update BaseModel email "hello@holbertonschool.com".
        """
        self.non_interactive_check()
        args = self.arg_string_parse(arguments)
        if self.not_a_class(args["cls_name"]):
    ...
    def default(self, line):
        ...
        Note:
            If input doesn't fit format, or class and method don't
            exist, an error message is printed to User
        """
    ...
    @staticmethod
    def count(cls_name):
        """ Returns number of instances of cls_name """
